...
/**
 * Because PacketEvents currently doesn't have a wrapper for the BossBar, we have to implement it ourselves.
 * Luckily, Tofaa2 is an incredible person and has already done the work here:
 * https://github.com/Tofaa2/packetevents/blob/2.0/api/src/main/java/com/github/retrooper/packetevents/wrapper/play/server/WrapperPlayServerBossBar.java
 *
 * Love you Tofaa!
 *
 * @Author: Tofaa2
